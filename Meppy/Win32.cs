...
namespace Wiltoga.Meppy
{
    public static class Win32
    {
        ...
        public static string SHGetKnownFolderPath(KnownFolder folder, uint dwFlags, nint hToken = 0) => SHGetKnownFolderPath(folder.Id, dwFlags, hToken);
        ...
        {
            private KnownFolder(string id)
            {
                Id = new(id);
            }

            public static KnownFolder Contacts { get; } = new("56784854-C6CB-462B-8169-88E350ACB882");
            public static KnownFolder Downloads { get; } = new("374DE290-123F-4565-9164-39C4925E467B");
            public static KnownFolder Favorites { get; } = new("1777F761-68AD-4D8A-87BD-30B759FA33DD");
            public static KnownFolder Links { get; } = new("BFB9D5E0-C6A9-404C-B2B2-AE6DB6AF4968");
            public static KnownFolder SavedGames { get; } = new("4C5C32FF-BB9D-43B0-B5B4-2D72E54EAAA4");
            public static KnownFolder SavedSearches { get; } = new("7D1D3A04-DEBB-4115-95CF-2F29DA2920DA");
